...
class BartQA:
    def __init__(self):
        ...
        # with open('./za/args/args_bart_train.pkl', 'wb') as f:
...
def main():
    ...
    sys.stdout.flush()
    if qa.args.do_train:
        with open('../Talk_/za/args/args_bart_train.pkl', 'wb') as f:
            pickle.dump(qa.args, f)
        qa.train()
    elif qa.args.do_eval:
        results = qa.evaluate(save_file=True)
        print(str(results))
    elif qa.args.do_generate:
        with open('../Talk_/za/args/args_bart_test.pkl', 'wb') as f:
            pickle.dump(qa.args, f)
        qa.generate()
    else:
