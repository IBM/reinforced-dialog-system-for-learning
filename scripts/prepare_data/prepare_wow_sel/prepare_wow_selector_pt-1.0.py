...
for idx_ins, instance in enumerate(instances):
    instance['negative_response'] = [instances[idx]['positive_response'] for idx in idx_ins2idxs_ins[idx_ins] if idx != idx_ins]

out_path = './data/WoW-selector-1.0/'
