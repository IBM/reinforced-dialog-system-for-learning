...
It evaluates two aspects:
    ...
    -- Coherence: DioGPT PPL
However, the selector is just a baseline one which has the following features:
    -- Do not consider the passage
    -- Based on Bert_tiny
Specifically, the generator takes in 1 sentences as reference 
'''
...
# score_wiz_ovlp: 0.18916897183827
# score_app_ovlp: 0.10734397857427065
# score_all_ovlp: 0.18192768507637472
...
# score_wiz_nvlp: 0.1688713830393446
# score_app_nvlp: 0.07075792929413802
# score_all_nvlp: 0.15621160748634755
