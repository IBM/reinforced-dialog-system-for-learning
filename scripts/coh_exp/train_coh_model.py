...
import sys
sys.path.append('/nonraidv/home/pengshancai/Talk/')
...
def main():
    ...
    with open('../Talk_/za/args/args_coh.pkl', 'wb') as f:
        pickle.dump(args, f)
    # exit()
    ...
    logging_.info(f"  Num Epochs = {args.num_train_epochs}")
    ...
    for epoch in range(args.num_train_epochs):
        ...
        logging_.info(f"epoch {epoch}: {eval_metric}")
    ...
    if args.task_name == "mnli":
        ...
        eval_metric = metric.compute()
        logging_.info(f"mnli-mm: {eval_metric}")
